...
#if !defined(MIMXRT1176_cm4_H_)  /* Check if memory map has not been already included */
#define MIMXRT1176_cm4_H_
...
#endif  /* #if !defined(MIMXRT1176_cm4_H_) */
