...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for ETHERNET_PLL
**
...
/*!
 * @file PERI_ETHERNET_PLL.h
 * @version 2.0
 * @date 2024-10-29
 * @brief CMSIS Peripheral Access Layer for ETHERNET_PLL
 *
 * CMSIS Peripheral Access Layer for ETHERNET_PLL
 */

#if !defined(PERI_ETHERNET_PLL_H_)
#define PERI_ETHERNET_PLL_H_                     /**< Symbol preventing repeated inclusion */
