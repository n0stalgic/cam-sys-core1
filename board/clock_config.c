...
/*******************************************************************************
 * Variables for BOARD_BootClockRUN_800M configuration
 ******************************************************************************/
...
const clock_video_pll_config_t videoPllConfig_BOARD_BootClockRUN_800M =
    {
        .loopDivider = 41,                        /* PLL Loop divider, valid range for DIV_SELECT divider value: 27 ~ 54. */
        .postDivider = 0,                         /* Divider after PLL, should only be 1, 2, 4, 8, 16, 32 */
        .numerator = 1,                           /* 30 bit numerator of fractional loop divider, Fout = Fin * ( loopDivider + numerator / denominator ) */
...
/*******************************************************************************
 * Code for BOARD_BootClockRUN_800M configuration
 ******************************************************************************/
void BOARD_BootClockRUN_800M(void)
{
    ...
    */
    /* Init Arm Pll. */
    CLOCK_InitArmPll(&armPllConfig_BOARD_BootClockRUN_800M);
    ...
    /* Init Sys Pll2. */
    CLOCK_InitSysPll2(&sysPll2Config_BOARD_BootClockRUN_800M);
    ...
    /* Init Video Pll. */
    CLOCK_InitVideoPll(&videoPllConfig_BOARD_BootClockRUN_800M);
